...
[![Android](https://img.shields.io/badge/android-v1.1.0-green.svg)](https://jitpack.io/#rockwotj/rosefire/android-v1.1.0)
...
```gradle
dependencies {
  compile 'com.github.rockwotj:rosefire:android-v1.1.0'
}
```
